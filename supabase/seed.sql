...
--
-- GIV-936: Image URLs point at self-hosted covers under
--          public/images/charities/ (served at /images/charities/...) instead
--          of the unreachable picsum.photos placeholder service.
-- =============================================================================
...
(
  ...
  '/images/charities/99-1230001.svg',
  '/images/charities/99-1230001.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230001.svg','/images/charities/default.svg','/images/charities/default.svg'],
  'B70', '1998', 'Active', 45,
  'verified', 312, 1847,
...
(
  ...
  '/images/charities/99-1230002.svg',
  '/images/charities/99-1230002.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230002.svg','/images/charities/default.svg','/images/charities/default.svg'],
  'E20', '2005', 'Active', 28,
  'verified', 198, 923,
...
(
  ...
  '/images/charities/99-1230003.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230003.svg','/images/charities/default.svg'],
  'C30', '2001', 'Active', 19,
  'verified', 445, 2103,
...
(
  ...
  '/images/charities/99-1230004.svg',
  '/images/charities/99-1230004.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230004.svg','/images/charities/default.svg'],
  'P60', '1989', 'Active', 72,
  'verified', 89, 514,
...
(
  ...
  '/images/charities/99-1230005.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230005.svg','/images/charities/default.svg','/images/charities/default.svg'],
  'A23', '1973', 'Active', 34,
  'verified', 267, 1392,
...
(
  ...
  '/images/charities/99-1230006.svg',
  '/images/charities/99-1230006.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230006.svg','/images/charities/default.svg'],
  'K31', '2010', 'Active', 52,
  'verified', 521, 3241,
...
(
  ...
  '/images/charities/99-1230007.svg',
  '/images/charities/99-1230007.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230007.svg','/images/charities/default.svg'],
  'O50', '2015', 'Active', 11,
  'verified', 134, 678,
...
(
  ...
  '/images/charities/99-1230008.svg',
  '/images/charities/99-1230008.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230008.svg','/images/charities/default.svg','/images/charities/default.svg'],
  'D20', '2008', 'Active', 16,
  'verified', 389, 2087,
...
(
  ...
  '/images/charities/99-1230009.svg',
  '/images/charities/99-1230009.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230009.svg','/images/charities/default.svg'],
  'Q33', '1995', 'Active', 38,
  'verified', 712, 4506,
...
(
  ...
  '/images/charities/99-1230010.svg',
  '/images/charities/99-1230010.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230010.svg','/images/charities/default.svg'],
  'L21', '2003', 'Active', 61,
  'verified', 156, 891,
  'Rebecca Torres', 'CEO',
...
(
  ...
  '/images/charities/99-1230011.svg',
  '/images/charities/99-1230011.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230011.svg','/images/charities/default.svg','/images/charities/default.svg'],
  'S20', '2000', 'Active', 29,
  'verified', 203, 1124,
...
(
  ...
  '/images/charities/99-1230012.svg',
  '/images/charities/99-1230012.svg',
  '/images/charities/default.svg',
  ARRAY['/images/charities/99-1230012.svg','/images/charities/default.svg'],
  'F32', '2012', 'Active', 23,
  'verified', 441, 2756,
