...
- Contribute to **Cause-Specific Impact Funds (CIFs)** — pooled vehicles that spread giving across multiple charities within a cause area
...
- **CIF distribution** across multiple charity addresses
