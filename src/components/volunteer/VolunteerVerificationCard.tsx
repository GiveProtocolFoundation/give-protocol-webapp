      ...
      <div className="space-y-4">
        {verification.applicantName && (
          <dl className="flex items-start">
            ...
            <dt className="text-sm font-medium text-gray-500">{t("volunteer.volunteerLabel", "Volunteer")}
        ...
        {verification.opportunityTitle && (
          <dl className="flex items-start">
            ...
            <dt className="text-sm font-medium text-gray-500">{t("volunteer.opportunityLabel", "Opportunity")}
        ...
        {verification.charityName && (
          <dl className="flex items-start">
            ...
            <dt className="text-sm font-medium text-gray-500">{t("volunteer.organizationLabel", "Organization")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {verification.acceptedAt && (
            <dl className="flex items-start">
              ...
              <dt className="text-sm font-medium text-gray-500">{t("volunteer.acceptedOn", "Accepted On")}
          ...
          {verification.verifiedAt && (
            <dl className="flex items-start">
              <Calendar className="h-5 w-5 text-gray-400 mt-0.5 mr-2" />
              <dt className="text-sm font-medium text-gray-500">{t("volunteer.verifiedOn", "Verified On")}
        ...
        <div className="border-t border-gray-200 pt-4 mt-4">
          <h4 className="text-sm font-medium text-gray-500 mb-2">{t("volunteer.verificationHashes", "Verification Hashes")}</h4>

          {verification.acceptanceHash && (
            <div className="mb-2">
              <p className="text-xs text-gray-500">{t("volunteer.acceptanceHash", "Acceptance Hash")}</p>
          ...
          {verification.verificationHash && (
            <div className="mb-2">
              <p className="text-xs text-gray-500">{t("volunteer.verificationHash", "Verification Hash")}</p>
          ...
          {verification.blockchainReference && (
            <div className="mt-4">
              <p className="text-xs text-gray-500">{t("volunteer.blockchainReference", "Blockchain Reference")}</p>
              <div className="flex items-center mt-1">
                ...
                <span className="text-xs text-gray-500 ml-2">
                  {t("blockchain.block", "Block")} #{verification.blockchainReference.blockNumber}
                </span>
              </div>
            </div>
          )}
