...
export const FormInput: React.FC<FormInputProps> = ({ icon, className, ...props }) => (
  <div className="relative">
    ...
    <input
      className={className || "w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white"}
      {...props}
    />
  </div>
);
