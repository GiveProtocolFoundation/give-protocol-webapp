export default {
  translation: {
    ...
    "admin.charity.colEin": "납세자 번호",
    "admin.charity.taxIdDisplay": "납세자 번호 {{value}}",
    "admin.charity.searchByNameEin": "이름 또는 납세자 번호로 검색…",
    ...
    "admin.charityRequests.subtitle":
      "기부자가 제출한 미등록 자선단체 요청으로 조직별로 그룹화되어 있습니다. 관심도가 높은 단체를 우선적으로 연락해야 합니다.",
    "admin.charityRequests.ein": "납세자 번호",
    ...
    "admin.charityRequests.showing":
      "총 {{total}}개 고유 조직 중 {{shown}}개 표시 중.",
    ...
    "auth.signin.sslEncrypted": "TLS 암호화",
    "auth.signin.modeToggleLabel": "로그인 방법",
    ...
    "browse.charity.nteeLabel": "부문 코드",
    ...
    "charity.profile.rowRulingYear": "등록 연도",
    "charity.profile.rowNteeCode": "부문 코드",
    ...
    "admin.auditTrail.filterByAction": "작업별 필터",
    "admin.auditTrail.allActions": "모든 작업",
    "admin.auditTrail.action.charityStatusChange": "자선단체 상태 변경",
    "admin.auditTrail.action.userStatusChange": "사용자 상태 변경",
    "admin.auditTrail.action.donationFlag": "기부 플래그 지정",
    "admin.auditTrail.action.donationFlagResolve": "기부 플래그 해제",
    "admin.auditTrail.action.validationOverride": "검증 재정의",
    "admin.auditTrail.action.configChange": "설정 변경",
    "admin.auditTrail.action.verificationApprove": "인증 승인",
    "admin.auditTrail.action.verificationReject": "인증 거부",
    "admin.auditTrail.action.charitySuspend": "자선단체 정지",
    "admin.auditTrail.action.charityReinstate": "자선단체 복원",
    "admin.auditTrail.action.userSuspend": "사용자 정지",
    "admin.auditTrail.action.userReinstate": "사용자 복원",
    "admin.auditTrail.action.userBan": "사용자 차단",
    "admin.auditTrail.action.viewPii": "PII 조회",
    "admin.auditTrail.action.viewPiiList": "PII 목록 조회",
    "admin.auditTrail.viewedEntity":
      "관리자 {{adminId}}가 {{entityType}} {{entityId}}을(를) 조회했습니다",
    "admin.auditTrail.viewedList":
      "관리자 {{adminId}}가 {{entityType}} 목록을 조회했습니다 (페이지 {{page}}, 필터: {{filters}})",
    "admin.auditTrail.viewedListNoFilters":
      "관리자 {{adminId}}가 {{entityType}} 목록을 조회했습니다 (페이지 {{page}})",
    "admin.actions.platformNews": "플랫폼 뉴스",
    "admin.actions.platformNewsDesc": "찾아보기 페이지의 뉴스 항목 관리",
    "admin.news.activate": "{{title}} 게시",
    "admin.news.activated": "뉴스 항목이 게시되었습니다",
    "admin.news.activeLabel": "게시됨 (공개 표시)",
    "admin.news.categoryLabel": "카테고리",
    "admin.news.contentLabel": "내용 / 발췌문",
    "admin.news.contentPlaceholder": "뉴스 항목에 대한 간단한 설명...",
    "admin.news.createNews": "뉴스 항목 만들기",
    "admin.news.createNewsBtn": "뉴스 만들기",
    "admin.news.created": "뉴스 항목이 생성되었습니다",
    "admin.news.dateLabel": "게시일",
    "admin.news.deactivate": "{{title}} 게시 중지",
    "admin.news.deactivated": "뉴스 항목이 숨겨졌습니다",
    "admin.news.deleteItem": "{{title}} 삭제",
    "admin.news.deleted": "뉴스 항목이 삭제되었습니다",
    "admin.news.editItem": "{{title}} 편집",
    "admin.news.editNews": "뉴스 항목 편집",
    "admin.news.imageLabel": "이미지 URL (선택 사항)",
    "admin.news.imagePlaceholder": "https://...",
    "admin.news.inactive": "비활성",
    "admin.news.newItem": "새 항목",
    "admin.news.noItemsMessage":
      "첫 번째 뉴스 항목을 만들어 커뮤니티에 소식을 전해보세요",
    "admin.news.noItemsYet": "아직 뉴스 항목이 없습니다",
    "admin.news.publishedOn": "{{date}}에 게시됨",
    "admin.news.saving": "저장 중...",
    "admin.news.subtitle": "공개 찾아보기 페이지에 표시되는 뉴스 항목 관리",
    "admin.news.title": "플랫폼 뉴스",
    "admin.news.titleLabel": "제목",
    "admin.news.titlePlaceholder": "예: 분기별 임팩트 보고서",
    "admin.news.updateNews": "뉴스 업데이트",
    "admin.news.updated": "뉴스 항목이 업데이트되었습니다",
    "admin.news.urlLabel": "링크 URL",
    "admin.news.urlPlaceholder": "/news/my-article",
    "charity.walletBadge.institutionalLabel": "{{custodianName}}에 보관됨",
    "charity.walletBadge.institutionalTooltip":
      "기부금은 공인된 기관 수탁기관이 관리하는 지갑으로 전달됩니다.",
    "charity.walletBadge.safeLabel":
      "멀티시그 트레저리 · {{threshold}}/{{count}} 서명자",
    "charity.walletBadge.safeTooltip":
      "기부금은 자금 이동 전 여러 승인이 필요한 다중 서명 지갑으로 전달됩니다.",
    "wallet.eoa.chain": "네트워크",
    "wallet.eoa.checkAuthorized":
      "본인은 자선단체를 대신하여 이 지갑을 기부금 수령 주소로 지정할 권한이 있음을 확인합니다.",
    "wallet.eoa.checkRisk":
      "단일 서명자 지갑은 멀티시그보다 위험이 높으며, 개인 키를 분실하면 자금을 영구적으로 잃게 된다는 것을 이해합니다.",
    "wallet.eoa.confirmSubtitle":
      "이 지갑을 등록하기 전에 다음 사항을 확인해 주세요.",
    "wallet.eoa.confirmTitle": "최종 확인",
    "wallet.eoa.connectFirst": "먼저 지갑을 연결해 주세요.",
    "wallet.eoa.connectWallet": "지갑 연결",
    "wallet.eoa.missingSignature":
      "서명이 누락되었습니다. 돌아가서 다시 서명해 주세요.",
    "wallet.eoa.proceedAnyway": "이해했으며 계속 진행합니다",
    "wallet.eoa.register": "지갑 등록",
    "wallet.eoa.registering": "등록 중...",
    "wallet.eoa.rejected": "서명 요청이 거부되었습니다.",
    "wallet.eoa.riskParagraph1":
      "단일 서명자(EOA) 지갑은 하나의 개인 키로 제어됩니다. 이 키를 분실, 도난 또는 침해당하면 이 지갑으로 전송된 모든 자금을 영구적으로 복구할 수 없습니다.",
    "wallet.eoa.riskParagraph2":
      "조직 자금의 경우, 대신 멀티시그 Safe 지갑을 사용할 것을 강력히 권장합니다. 멀티시그 지갑은 모든 거래에 여러 승인을 요구하여 단일 장애 지점을 방지합니다.",
    "wallet.eoa.riskParagraph3":
      "계속 진행함으로써, 개인 키의 침해, 분실 또는 부적절한 관리로 인한 자금 손실에 대해 Give Protocol이 책임지지 않는다는 점에 동의합니다.",
    "wallet.eoa.riskTitle": "단일 서명자 지갑: 중요한 위험 사항",
    "wallet.eoa.signError": "메시지 서명에 실패했습니다. 다시 시도해 주세요.",
    "wallet.eoa.signMessage": "확인 메시지 서명",
    "wallet.eoa.signSubtitle":
      "지갑을 연결하고 이 주소를 소유하고 있음을 증명하기 위해 메시지에 서명하세요.",
    "wallet.eoa.signTitle": "연결 및 서명",
    "wallet.eoa.useMultisig": "대신 멀티시그 사용",
    "wallet.eoa.walletConnection": "지갑",
    "wallet.eoa.walletToRegister": "등록할 지갑",
    "wallet.institutional.address": "지갑 주소",
    "wallet.institutional.attestation": "증명 문서",
    "wallet.institutional.attestationHelp":
      "수탁 관계를 증명하는 PDF, JPEG 또는 PNG 파일을 업로드하세요 (최대 10MB).",
    "wallet.institutional.backToWallets": "지갑 목록으로 돌아가기",
    "wallet.institutional.chain": "네트워크",
    "wallet.institutional.chooseFile": "파일 선택 또는 드래그 앤 드롭",
    "wallet.institutional.custodian": "수탁기관",
    "wallet.institutional.fileTooLarge": "파일 크기는 10MB 미만이어야 합니다.",
    "wallet.institutional.invalidAddress":
      "유효한 이더리움 주소를 입력해 주세요 (0x...)",
    "wallet.institutional.invalidFileType":
      "PDF, JPEG 또는 PNG 파일을 업로드해 주세요.",
    "wallet.institutional.removeFile": "파일 제거",
    "wallet.institutional.selectCustodian": "수탁기관을 선택해 주세요.",
    "wallet.institutional.selectCustodianOption": "수탁기관 선택...",
    "wallet.institutional.submit": "검토용 제출",
    "wallet.institutional.submittedDesc":
      "기관 수탁 지갑 등록이 검토 중입니다. 영업일 기준 3일 이내에 이메일을 받으실 수 있습니다.",
    "wallet.institutional.submittedTitle": "지갑이 검토용으로 제출되었습니다",
    "wallet.institutional.submitting": "제출 중...",
    "wallet.institutional.subtitle":
      "수탁기관이 관리하는 지갑 정보를 제공하고 검증을 위해 증명 문서를 업로드하세요.",
    "wallet.institutional.title": "기관 수탁 지갑 등록",
    "wallet.institutional.uploadFile": "증명 파일 업로드",
    "wallet.institutional.uploadRequired": "증명 문서를 업로드해 주세요.",
    "wallet.safe.address": "Safe 주소",
    "wallet.safe.chain": "네트워크",
    "wallet.safe.connectFirst": "먼저 서명자 지갑을 연결해 주세요.",
    "wallet.safe.connectSigner": "서명자 지갑 연결",
    "wallet.safe.createNew": "새 Safe 만들기",
    "wallet.safe.createNewDesc":
      "app.safe.global을 열어 새 멀티시그를 만들 수 있습니다. 배포가 완료되면 이곳으로 돌아오세요.",
    "wallet.safe.haveOne": "이미 Safe가 있습니다",
    "wallet.safe.haveOneDesc":
      "Safe 주소를 입력하고 서명자 지갑으로 메시지에 서명하여 소유권을 확인하세요.",
    "wallet.safe.invalidAddress":
      "유효한 이더리움 주소를 입력해 주세요 (0x...)",
    "wallet.safe.rejected": "서명 요청이 거부되었습니다.",
    "wallet.safe.signError":
      "확인 메시지 서명에 실패했습니다. 다시 시도해 주세요.",
    "wallet.safe.signVerify": "서명하여 소유권 확인",
    "wallet.safe.signerWallet": "서명자 지갑",
    "wallet.safe.subtitle":
      "Safe는 모든 거래를 승인하기 위해 여러 서명자가 필요하며, 자선단체 자금에 최고 수준의 보안을 제공합니다.",
    "wallet.safe.title": "Safe 멀티시그 지갑 설정",
    "wallet.safe.verifyTitle": "Safe 소유권 확인",
    "wallet.safe.verifying": "확인 중...",
    "wallet.setup.addAnother": "추가",
    "wallet.setup.custodian": "수탁기관",
    "wallet.setup.deleteFailed": "지갑 제거에 실패했습니다",
    "wallet.setup.eoaDesc":
      "하나의 개인 키로 제어되는 표준 지갑입니다. 가장 간단하지만 조직 사용에는 보안성이 가장 낮습니다.",
    "wallet.setup.eoaTitle": "단일 서명자 (EOA)",
    "wallet.setup.institutionalDesc":
      "공인 수탁기관(Fireblocks, Anchorage 등)이 관리합니다. 증명 문서가 필요합니다.",
    "wallet.setup.institutionalTitle": "기관 수탁",
    "wallet.setup.makePrimary": "기본으로 설정",
    "wallet.setup.primary": "기본",
    "wallet.setup.primaryFailed": "기본 지갑 업데이트에 실패했습니다",
    "wallet.setup.primaryUpdated": "기본 지갑이 업데이트되었습니다",
    "wallet.setup.recommended": "권장",
    "wallet.setup.remove": "지갑 제거",
    "wallet.setup.safeDesc":
      "모든 거래에 여러 서명자가 필요합니다. 조직 자금에 최고 수준의 보안을 제공합니다.",
    "wallet.setup.safeSigners": "서명자",
    "wallet.setup.safeTitle": "멀티시그 Safe",
    "wallet.setup.subtitle":
      "자선단체가 암호화폐 기부금을 수령할 방법을 선택하세요. 최대 보안을 위해 멀티시그 지갑을 권장합니다.",
    "wallet.setup.title": "수령 지갑 설정",
    "wallet.setup.viewExplorer": "블록 탐색기에서 보기",
    "wallet.setup.walletAdded": "지갑이 성공적으로 등록되었습니다",
    "wallet.setup.walletDeleted": "지갑이 제거되었습니다",
    "wallet.setup.walletsTitle": "수령 지갑",
    "admin.nav.dashboard": "대시보드",
    "admin.nav.reports": "보고서 및 분석",
    "admin.nav.charities": "자선단체",
    "admin.nav.donations": "기부",
    "admin.nav.impactMetrics": "임팩트 지표",
    "admin.nav.portfolioFunds": "포트폴리오 펀드",
    "admin.nav.contentModeration": "콘텐츠 모더레이션",
    "admin.nav.settings": "시스템 설정",
    "admin.nav.overview": "개요",
    "admin.nav.operations": "운영",
    "admin.nav.consoleLabel": "관리자 콘솔",
    "admin.shell.searchPlaceholder": "기부자, 자선단체, 거래 해시 검색…",
    "admin.shell.searchLabel": "관리자 콘솔 검색",
    "admin.shell.notifications": "알림",
    "admin.shell.adminLabel": "관리자",
    "admin.shell.superAdmin": "최고 관리자",
    "admin.shell.signOut": "로그아웃",
    "admin.shell.backToPublicSite": "공개 사이트로 돌아가기",
    "admin.shell.homeLink": "Give Protocol 홈",
    "admin.dashboard.severityHigh": "높은 우선순위",
    ...
    "admin.dashboard.awaitingVerification": "인증 대기 중",
    "admin.dashboard.kpiVerifiedSub": "전체 승인 {{total}}건 중",
    "admin.dashboard.kpiVolunteersActive": "활성 신청",
    "admin.dashboard.kpiVolunteersSub": "활성 신청 없음",
    "admin.dashboard.donationVolume": "기부 규모",
    "admin.dashboard.donationVolumeSub": "{{range}} · 암호화폐 + 법정화폐 합산",
    "admin.dashboard.range30d": "최근 30일",
    "admin.dashboard.range90d": "최근 90일",
    "admin.dashboard.rangeYtd": "연초 이후",
    "admin.dashboard.volumeEmptyTitle": "아직 기록된 기부가 없습니다",
    "admin.dashboard.volumeEmptySub":
      "첫 번째 기부가 정산되면 이곳에 규모가 표시됩니다",
    "admin.dashboard.totalVolume": "총 규모",
    "admin.dashboard.crypto": "암호화폐",
    "admin.dashboard.fiat": "법정화폐",
    "admin.dashboard.activitySubtitle": "실시간 플랫폼 이벤트",
    "admin.dashboard.viewAllActivity": "모든 활동 보기",
    "admin.dashboard.viewAllDonations": "모든 기부 보기",
    "admin.charity.tabAll": "전체",
    "admin.charity.review": "검토",
    "admin.charity.colOrganization": "단체",
    "admin.charity.colRaised": "모금액",
    "admin.charity.colSubmitted": "제출일",
    "admin.charity.searchAria": "자선단체 검색",
    "admin.charity.reviewTitle": "{{name}} 검토",
    "admin.charity.submittedRelative": "{{when}}에 제출됨",
    "admin.charity.contactEmail": "이메일",
    "admin.charity.contactPhone": "전화번호",
    "admin.charity.raisedUnavailable": "이용 가능한 모금 총액이 없습니다",
    "admin.error.title": "데이터 로드 오류",
    "admin.error.recentActivity": "최근 활동 로드 오류",
    "admin.error.alerts": "알림 로드 오류",
    "admin.error.donationVolume": "기부 규모 로드 오류",
    "donation.gas.estimating": "네트워크 수수료 산정 중…",
    "donation.gas.label": "예상 네트워크 수수료",
