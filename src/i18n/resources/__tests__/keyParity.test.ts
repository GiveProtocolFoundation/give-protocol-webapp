...
const KNOWN_UNTRANSLATED_KEYS = new Set<string>([
  ...
  // Admin console redesign — operations shell, restyled Dashboard & Charity
  // list view. English-first; translations to follow.
  "admin.nav.dashboard",
  "admin.nav.reports",
  "admin.nav.charities",
  "admin.nav.donations",
  "admin.nav.impactMetrics",
  "admin.nav.portfolioFunds",
  "admin.nav.contentModeration",
  "admin.nav.settings",
  "admin.nav.overview",
  "admin.nav.operations",
  "admin.nav.consoleLabel",
  ...
  "admin.charity.colRaised",
  "admin.charity.colSubmitted",
  "admin.charity.searchAria",
  "admin.charity.reviewTitle",
  "admin.charity.submittedRelative",
