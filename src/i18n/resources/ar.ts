export default {
  translation: {
    ...
    "volunteer.understanding.item1":
      "ستتم معالجة معلوماتي الشخصية لتقييم طلب التطوع الخاص بي، وإدارة مهام التطوع، وتنفيذ الأنشطة ذات الصلة. هذه المعالجة ضرورية لاتخاذ الخطوات بناءً على طلبي قبل إبرام أي ترتيب للتطوع ولتنفيذه (المادة 6(1)(ب) من اللائحة العامة لحماية البيانات)؛ ولا تستند إلى موافقتي.",
