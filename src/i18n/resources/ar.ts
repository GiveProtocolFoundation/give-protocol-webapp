export default {
  translation: {
    ...
    "privacy.security.auditLog":
      "كإجراء تقني بموجب المادة 32 من اللائحة العامة لحماية البيانات (GDPR)، نقوم بتسجيل ومراقبة الوصول الإداري إلى البيانات الشخصية — بما في ذلك الإجراء المتخذ ووقت حدوثه — للكشف عن الوصول غير المصرح به، وإثبات المساءلة، وإعادة بناء الأحداث في الحالة غير المحتملة لحدوث خرق للبيانات الشخصية (المادة 34). لا يتم نسخ البيانات الشخصية للمتبرعين في سجلات الوصول الإداري هذه. تختلف سجلات الوصول الإداري عن سجلات المصادقة والأمان الموصوفة في §7.1؛ ويخضع فترة الاحتفاظ بها لسجل أنشطة المعالجة الداخلي لدينا.",
  },
};
