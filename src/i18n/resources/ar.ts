export default {
  translation: {
    ...
    "volunteer.understanding.item1":
      "ستتم معالجة معلوماتي الشخصية لتقييم طلب التطوع الخاص بي، وإدارة مهام التطوع، وتنفيذ الأنشطة ذات الصلة. هذه المعالجة ضرورية لاتخاذ الخطوات بناءً على طلبي قبل إبرام أي ترتيب للتطوع ولتنفيذه (المادة 6(1)(b) من اللائحة العامة لحماية البيانات)؛ ولا تستند إلى موافقتي.",
    "volunteer.understanding.item2":
      "قد تجمع GIVE PROTOCOL فئات مختلفة من معلوماتي الشخصية، بما في ذلك معلومات الهوية والتفاصيل الاتصالية ومعلومات الخلفية والتوافر والمراجع. لا يجب أن أُدرج في حقول النص الحر فئات خاصة من البيانات (مثل المعلومات المتعلقة بالصحة أو الأصل العرقي أو الإثني أو المعتقدات الدينية أو السياسية أو العضوية في النقابات أو الحياة الجنسية أو التوجه الجنسي)، إذ إن مثل هذه البيانات غير مطلوبة لتقييم طلبي.",
    "volunteer.understanding.item3":
      "قد تتم مشاركة معلوماتي الشخصية مع الموظفين المرخص لهم داخل المنظمة الخيرية التي تقدم فرصة التطوع، ومزودي الخدمات، والأطراف الثالثة كما هو موضح في إشعار الخصوصية.",
    "volunteer.understanding.item4":
      "عندما يقع مزود الخدمة خارج بلد إقامتي، قد يتم نقل معلوماتي الشخصية دولياً وفق ضمانات مناسبة (مثل البنود التعاقدية القياسية) كما هو موضح في إشعار الخصوصية. لا تستند عمليات النقل هذه إلى موافقتي.",
    "volunteer.understanding.item5":
      "لدي حقوق معينة فيما يتعلق بمعلوماتي الشخصية، تتفاوت وفقاً لموقعي، بما في ذلك حقوق الوصول والتصحيح والحذف وتقييد المعالجة وقابلية نقل البيانات والاعتراض على المعالجة.",
    "volunteer.understanding.item6Before":
      "يمكنني الاعتراض على المعالجة (المادة 21 من اللائحة العامة لحماية البيانات) وطلب مسح معلوماتي الشخصية (المادة 17 من اللائحة العامة لحماية البيانات) من خلال التواصل مع",
    "volunteer.understanding.item6After":
      ". عندما تستند أي معالجة محددة إلى موافقتي، يمكنني سحب تلك الموافقة في أي وقت دون التأثير على مشروعية المعالجة التي تمت قبل السحب. قد يؤثر الاعتراض أو طلب المسح على قدرة المنظمة في النظر في طلب التطوع الخاص بي.",
