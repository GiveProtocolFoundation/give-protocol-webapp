export default {
  translation: {
    ...
    "charity.profile.donate.walletUnset": "この団体はまだ公式の受取ウォレットを設定していません。",
    "charity.profile.donate.walletPending": "この団体はウォレットの設定中です — 寄付は一時的に利用できません。",
    "charity.profile.donate.walletLegacy": "この団体はレガシーウォレットアドレスを使用しています。",
    "charity.profile.donate.feeNote": "直接寄付のプラットフォーム手数料は0%です。ネットワーク手数料が適用されます。",
