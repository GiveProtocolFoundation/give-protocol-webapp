export default {
  translation: {
    ...
    "volunteer.understanding.item1":
      "私の個人情報は、ボランティア申請の審査、ボランティア任務の管理、および関連活動の実施のために処理されます。この処理は、ボランティア契約の締結前に私の要請に基づく手続きを行い、またその契約を履行するために必要です（GDPR第6条(1)(b)）；私の同意に基づくものではありません。",
    "volunteer.understanding.item2":
      "GIVE PROTOCOLは、身元情報、連絡先情報、経歴情報、対応可能時間、推薦者情報を含む、さまざまなカテゴリーの個人情報を収集する場合があります。自由記述欄には、健康状態、人種・民族的出自、宗教的・政治的信条、労働組合加入状況、性生活や性的指向に関する情報などの特別カテゴリーのデータを含めないでください。そのようなデータは申請審査に必要ありません。",
    "volunteer.understanding.item3":
      "私の個人情報は、ボランティア機会を提供する慈善団体の担当者、サービス提供者、および個人情報保護方針に記載された第三者と共有される場合があります。",
    "volunteer.understanding.item4":
      "サービス提供者が私の居住国の外に所在する場合、私の個人情報は、個人情報保護方針に記載されているように、適切な保護措置（標準契約条項など）の下で国際的に移転される場合があります。これらの移転は私の同意に基づくものではありません。",
    "volunteer.understanding.item5":
      "私の個人情報に関して、所在地に応じて異なる一定の権利（アクセス、訂正、削除、処理制限、データポータビリティ、処理への異議申し立ての権利を含む）を有します。",
    "volunteer.understanding.item6Before":
      "私は処理に異議を申し立て（GDPR第21条）、私の個人情報の削除を要請する（GDPR第17条）ことができます。次の連絡先までご連絡ください：",
    "volunteer.understanding.item6After":
      "。特定の処理が私の同意に基づく場合、私はその同意をいつでも撤回することができ、これは撤回前に行われた処理の適法性に影響を与えません。異議申し立てまたは削除要請は、組織が私のボランティア申請を検討する能力に影響を与える場合があります。",
