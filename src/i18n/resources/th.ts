export default {
  translation: {
    ...
    "privacy.security.auditLog":
      "เพื่อเป็นมาตรการทางเทคนิคตามข้อ 32 ของ GDPR เราบันทึกและตรวจสอบการเข้าถึงข้อมูลส่วนบุคคลโดยผู้ดูแลระบบ — รวมถึงการดำเนินการที่ทำและเวลาที่เกิดขึ้น — เพื่อตรวจจับการเข้าถึงโดยไม่ได้รับอนุญาต แสดงความรับผิดชอบ และสร้างเหตุการณ์ขึ้นใหม่ในกรณีที่ไม่น่าจะเกิดขึ้นของการละเมิดข้อมูลส่วนบุคคล (ข้อ 34) ข้อมูลส่วนบุคคลของผู้บริจาคจะไม่ถูกทำซ้ำในบันทึกการเข้าถึงโดยผู้ดูแลระบบเหล่านี้ บันทึกการเข้าถึงโดยผู้ดูแลระบบแตกต่างจากบันทึกการยืนยันตัวตนและความปลอดภัยที่อธิบายไว้ใน §7.1 ระยะเวลาการเก็บรักษาข้อมูลถูกกำหนดโดยบันทึกกิจกรรมการประมวลผลภายในของเรา",
  },
};
