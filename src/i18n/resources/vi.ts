export default {
  translation: {
    ...
    "admin.charity.colEin": "Mã số thuế",
    "admin.charity.taxIdDisplay": "Mã số thuế {{value}}",
    "admin.charity.searchByNameEin": "Tìm theo tên hoặc mã số thuế…",
    ...
    "admin.charityRequests.subtitle":
      "Yêu cầu do nhà tài trợ gửi cho các tổ chức chưa được nhận, nhóm theo tổ chức. Các tổ chức có lượt quan tâm cao nhất nên được ưu tiên liên hệ.",
    "admin.charityRequests.ein": "Mã số thuế",
    ...
    "admin.charityRequests.showing":
      "Hiển thị {{shown}} trong số {{total}} tổ chức duy nhất.",
    ...
    "charity.claim.einLabel": "Mã số thuế",
    ...
    "portfolio.notFound.body": "Quỹ danh mục bạn đang tìm không tồn tại hoặc không còn hoạt động.",
    ...
    "charity.profile.rowRulingYear": "Năm đăng ký",
    "charity.profile.rowNteeCode": "Mã ngành",
    ...
    "privacy.security.auditLog":
      "Là biện pháp kỹ thuật theo Điều 32 của GDPR, chúng tôi ghi nhật ký và giám sát quyền truy cập quản trị vào dữ liệu cá nhân — bao gồm hành động đã thực hiện và thời điểm xảy ra — để phát hiện truy cập trái phép, chứng minh trách nhiệm giải trình và tái dựng các sự kiện trong trường hợp không mong muốn xảy ra vi phạm dữ liệu cá nhân (Điều 34). Dữ liệu cá nhân của nhà tài trợ không được sao chép vào các nhật ký truy cập quản trị này. Nhật ký truy cập quản trị khác biệt với nhật ký xác thực và bảo mật được mô tả trong §7.1; thời hạn lưu giữ của chúng được quản lý bởi Hồ sơ Hoạt động Xử lý nội bộ của chúng tôi.",

    // Remaining i18n keys — batch translation
    "admin.auditTrail.filterByAction": "Lọc theo hành động",
    "admin.auditTrail.allActions": "Tất cả hành động",
    "admin.auditTrail.action.charityStatusChange":
      "Thay đổi trạng thái tổ chức từ thiện",
    "admin.auditTrail.action.userStatusChange":
      "Thay đổi trạng thái người dùng",
    "admin.auditTrail.action.donationFlag": "Gắn cờ quyên góp",
    "admin.auditTrail.action.donationFlagResolve": "Giải quyết cờ quyên góp",
    "admin.auditTrail.action.validationOverride": "Ghi đè xác thực",
    "admin.auditTrail.action.configChange": "Thay đổi cấu hình",
    "admin.auditTrail.action.verificationApprove": "Phê duyệt xác minh",
    "admin.auditTrail.action.verificationReject": "Từ chối xác minh",
    "admin.auditTrail.action.charitySuspend": "Tạm ngưng tổ chức từ thiện",
    "admin.auditTrail.action.charityReinstate": "Khôi phục tổ chức từ thiện",
    "admin.auditTrail.action.userSuspend": "Tạm ngưng người dùng",
    "admin.auditTrail.action.userReinstate": "Khôi phục người dùng",
    "admin.auditTrail.action.userBan": "Cấm người dùng",
    "admin.auditTrail.action.viewPii": "Xem thông tin cá nhân (PII)",
    "admin.auditTrail.action.viewPiiList":
      "Xem danh sách thông tin cá nhân (PII)",
    "admin.auditTrail.viewedEntity":
      "Quản trị viên {{adminId}} đã xem {{entityType}} {{entityId}}",
    "admin.auditTrail.viewedList":
      "Quản trị viên {{adminId}} đã xem danh sách {{entityType}} (trang {{page}}, bộ lọc: {{filters}})",
    "admin.auditTrail.viewedListNoFilters":
      "Quản trị viên {{adminId}} đã xem danh sách {{entityType}} (trang {{page}})",
    "admin.actions.platformNews": "Tin tức nền tảng",
    "admin.actions.platformNewsDesc":
      "Quản lý các mục tin tức trên trang duyệt xem",
    "admin.news.activate": "Kích hoạt {{title}}",
    "admin.news.activated": "Đã đăng mục tin tức",
    "admin.news.activeLabel": "Đã đăng (hiển thị công khai)",
    "admin.news.categoryLabel": "Danh mục",
    "admin.news.contentLabel": "Nội dung / Đoạn trích",
    "admin.news.contentPlaceholder": "Mô tả ngắn gọn về mục tin tức...",
    "admin.news.createNews": "Tạo mục tin tức",
    "admin.news.createNewsBtn": "Tạo tin tức",
    "admin.news.created": "Đã tạo mục tin tức",
    "admin.news.dateLabel": "Ngày đăng",
    "admin.news.deactivate": "Hủy kích hoạt {{title}}",
    "admin.news.deactivated": "Đã ẩn mục tin tức",
    "admin.news.deleteItem": "Xóa {{title}}",
    "admin.news.deleted": "Đã xóa mục tin tức",
    "admin.news.editItem": "Chỉnh sửa {{title}}",
    "admin.news.editNews": "Chỉnh sửa mục tin tức",
    "admin.news.imageLabel": "URL hình ảnh (tùy chọn)",
    "admin.news.imagePlaceholder": "https://...",
    "admin.news.inactive": "Không hoạt động",
    "admin.news.newItem": "Mục mới",
    "admin.news.noItemsMessage":
      "Tạo mục tin tức đầu tiên của bạn để chia sẻ cập nhật với cộng đồng",
    "admin.news.noItemsYet": "Chưa có mục tin tức nào",
    "admin.news.publishedOn": "Đã đăng {{date}}",
    "admin.news.saving": "Đang lưu...",
    "admin.news.subtitle":
      "Quản lý các mục tin tức hiển thị trên trang duyệt xem công khai",
    "admin.news.title": "Tin tức nền tảng",
    "admin.news.titleLabel": "Tiêu đề",
    "admin.news.titlePlaceholder": "vd: Báo cáo tác động hàng quý",
    "admin.news.updateNews": "Cập nhật tin tức",
    "admin.news.updated": "Đã cập nhật mục tin tức",
    "admin.news.urlLabel": "URL liên kết",
    "admin.news.urlPlaceholder": "/news/my-article",
    "charity.walletBadge.institutionalLabel":
      "Được lưu giữ tại {{custodianName}}",
    "charity.walletBadge.institutionalTooltip":
      "Các khoản quyên góp được chuyển đến ví do đơn vị lưu ký tổ chức đủ điều kiện nắm giữ.",
    "charity.walletBadge.safeLabel":
      "Ví kho bạc đa chữ ký · {{threshold}}/{{count}} người ký",
    "charity.walletBadge.safeTooltip":
      "Các khoản quyên góp được chuyển đến ví đa chữ ký yêu cầu nhiều phê duyệt trước khi tiền có thể được chuyển.",
    "wallet.eoa.chain": "Mạng lưới",
    "wallet.eoa.checkAuthorized":
      "Tôi được tổ chức của mình ủy quyền để chỉ định ví này làm địa chỉ nhận cho các khoản quyên góp từ thiện.",
    "wallet.eoa.checkRisk":
      "Tôi hiểu rằng ví một chữ ký mang rủi ro cao hơn ví đa chữ ký, và việc mất khóa riêng tư đồng nghĩa với việc mất tiền vĩnh viễn.",
    "wallet.eoa.confirmSubtitle":
      "Vui lòng xác nhận các điều sau trước khi đăng ký ví này.",
    ...
    "wallet.eoa.rejected": "Yêu cầu ký đã bị từ chối.",
    "wallet.eoa.riskParagraph1":
      "Ví một chữ ký (EOA) được kiểm soát bởi một khóa riêng tư duy nhất. Nếu khóa đó bị mất, bị đánh cắp hoặc bị xâm phạm, tất cả số tiền gửi đến ví này sẽ không thể khôi phục vĩnh viễn.",
    "wallet.eoa.riskParagraph2":
      "Đối với quỹ của tổ chức, chúng tôi khuyến nghị mạnh mẽ nên sử dụng ví Safe đa chữ ký thay thế. Ví đa chữ ký yêu cầu nhiều phê duyệt cho mỗi giao dịch, giúp bảo vệ khỏi các điểm lỗi đơn lẻ.",
    "wallet.eoa.riskParagraph3":
      "Bằng việc tiếp tục, bạn xác nhận rằng Give Protocol không chịu trách nhiệm về bất kỳ tổn thất tiền nào do khóa riêng tư bị xâm phạm, mất mát hoặc quản lý sai.",
    "wallet.eoa.riskTitle": "Ví một chữ ký: rủi ro quan trọng",
    "wallet.eoa.signError": "Ký thông báo không thành công. Vui lòng thử lại.",
    "wallet.eoa.signMessage": "Ký thông báo xác minh",
    "wallet.eoa.signSubtitle":
      "Kết nối ví của bạn và ký một thông báo để chứng minh bạn kiểm soát địa chỉ này.",
    "wallet.eoa.signTitle": "Kết nối và ký",
    "wallet.eoa.useMultisig": "Sử dụng ví đa chữ ký thay thế",
    "wallet.eoa.walletConnection": "Ví",
    "wallet.eoa.walletToRegister": "Ví cần đăng ký",
    "wallet.institutional.address": "Địa chỉ ví",
    "wallet.institutional.attestation": "Tài liệu chứng thực",
    "wallet.institutional.attestationHelp":
      "Tải lên tệp PDF, JPEG hoặc PNG (tối đa 10MB) chứng minh mối quan hệ lưu ký của bạn.",
    "wallet.institutional.backToWallets": "Quay lại danh sách ví",
    "wallet.institutional.chain": "Mạng lưới",
    "wallet.institutional.chooseFile": "Chọn tệp hoặc kéo & thả",
    "wallet.institutional.custodian": "Đơn vị lưu ký",
    "wallet.institutional.fileTooLarge": "Tệp phải nhỏ hơn 10MB.",
    "wallet.institutional.invalidAddress":
      "Vui lòng nhập địa chỉ Ethereum hợp lệ (0x...)",
    ...
    "wallet.institutional.submittedDesc":
      "Đăng ký ví lưu ký tổ chức của bạn đang được xem xét. Bạn sẽ nhận được email trong vòng 3 ngày làm việc.",
    "wallet.institutional.submittedTitle": "Đã gửi ví để xem xét",
    "wallet.institutional.submitting": "Đang gửi...",
    "wallet.institutional.subtitle":
      "Cung cấp thông tin ví do đơn vị lưu ký quản lý và tải lên tài liệu chứng thực để xác minh.",
    "wallet.institutional.title": "Đăng ký ví lưu ký tổ chức",
    "wallet.institutional.uploadFile": "Tải lên tệp chứng thực",
    "wallet.institutional.uploadRequired":
      "Vui lòng tải lên tài liệu chứng thực.",
    "wallet.safe.address": "Địa chỉ Safe",
    "wallet.safe.chain": "Mạng lưới",
    "wallet.safe.connectFirst": "Vui lòng kết nối ví ký của bạn trước.",
    "wallet.safe.connectSigner": "Kết nối ví ký",
    "wallet.safe.createNew": "Tạo Safe mới",
    "wallet.safe.createNewDesc":
      "Mở app.safe.global nơi bạn có thể tạo ví đa chữ ký mới. Quay lại đây sau khi đã triển khai xong.",
    "wallet.safe.haveOne": "Tôi đã có một Safe",
    "wallet.safe.haveOneDesc":
      "Nhập địa chỉ Safe của bạn và xác minh quyền kiểm soát bằng cách ký một thông báo từ ví ký.",
    "wallet.safe.invalidAddress":
      "Vui lòng nhập địa chỉ Ethereum hợp lệ (0x...)",
    "wallet.safe.rejected": "Yêu cầu ký đã bị từ chối.",
    "wallet.safe.signError":
      "Ký thông báo xác minh không thành công. Vui lòng thử lại.",
    "wallet.safe.signVerify": "Ký để xác minh quyền kiểm soát",
    "wallet.safe.signerWallet": "Ví ký",
    "wallet.safe.subtitle":
      "Safe yêu cầu nhiều người ký để phê duyệt mỗi giao dịch, mang lại mức độ bảo mật cao nhất cho quỹ của tổ chức từ thiện của bạn.",
    "wallet.safe.title": "Thiết lập ví đa chữ ký Safe",
    "wallet.safe.verifyTitle": "Xác minh quyền sở hữu Safe",
    "wallet.safe.verifying": "Đang xác minh...",
    "wallet.setup.addAnother": "Thêm ví khác",
    "wallet.setup.custodian": "Đơn vị lưu ký",
    "wallet.setup.deleteFailed": "Xóa ví không thành công",
    "wallet.setup.eoaDesc":
      "Ví tiêu chuẩn được kiểm soát bởi một khóa riêng tư. Đơn giản nhất nhưng kém an toàn nhất cho mục đích sử dụng của tổ chức.",
    "wallet.setup.eoaTitle": "Một chữ ký (EOA)",
    "wallet.setup.institutionalDesc":
      "Được quản lý bởi đơn vị lưu ký đủ điều kiện (Fireblocks, Anchorage, v.v.). Yêu cầu tài liệu chứng thực.",
    "wallet.setup.institutionalTitle": "Lưu ký tổ chức",
    "wallet.setup.makePrimary": "Đặt làm ví chính",
    "wallet.setup.primary": "Chính",
    "wallet.setup.primaryFailed": "Cập nhật ví chính không thành công",
    "wallet.setup.primaryUpdated": "Đã cập nhật ví chính",
    "wallet.setup.recommended": "Được đề xuất",
    "wallet.setup.remove": "Xóa ví",
    "wallet.setup.safeDesc":
      "Yêu cầu nhiều người ký cho mỗi giao dịch. Bảo mật cao nhất cho quỹ của tổ chức.",
    "wallet.setup.safeSigners": "Người ký",
    "wallet.setup.safeTitle": "Safe đa chữ ký",
    "wallet.setup.subtitle":
      "Chọn cách tổ chức từ thiện của bạn sẽ nhận quyên góp tiền mã hóa. Chúng tôi khuyến nghị ví đa chữ ký để đảm bảo an toàn tối đa.",
    "wallet.setup.title": "Thiết lập ví nhận của bạn",
    "wallet.setup.viewExplorer": "Xem trên trình khám phá khối",
    "wallet.setup.walletAdded": "Đăng ký ví thành công",
    "wallet.setup.walletDeleted": "Đã xóa ví",
    "wallet.setup.walletsTitle": "Ví nhận quyên góp",
    "admin.nav.dashboard": "Bảng điều khiển",
    "admin.nav.reports": "Báo cáo & Phân tích",
    "admin.nav.charities": "Tổ chức từ thiện",
    "admin.nav.donations": "Quyên góp",
    "admin.nav.impactMetrics": "Chỉ số tác động",
    "admin.nav.portfolioFunds": "Quỹ danh mục",
    "admin.nav.contentModeration": "Kiểm duyệt nội dung",
    "admin.nav.settings": "Cài đặt hệ thống",
    "admin.nav.overview": "Tổng quan",
    "admin.nav.operations": "Vận hành",
    "admin.nav.consoleLabel": "Bảng điều khiển quản trị",
    "admin.shell.searchPlaceholder":
      "Tìm kiếm nhà tài trợ, tổ chức từ thiện, mã giao dịch…",
    "admin.shell.searchLabel": "Tìm kiếm trong bảng điều khiển quản trị",
    "admin.shell.notifications": "Thông báo",
    "admin.shell.adminLabel": "quản trị viên",
    "admin.shell.superAdmin": "Quản trị viên cấp cao",
    "admin.shell.signOut": "Đăng xuất",
    "admin.shell.backToPublicSite": "Quay lại trang công khai",
    "admin.shell.homeLink": "Trang chủ Give Protocol",
    "admin.dashboard.severityHigh": "Ưu tiên cao",
    ...
    "admin.charity.review": "Xem xét",
    "admin.charity.colOrganization": "Tổ chức",
    "admin.charity.colRaised": "Đã quyên góp được",
    "admin.charity.colSubmitted": "Đã gửi",
    "admin.charity.searchAria": "Tìm kiếm tổ chức từ thiện",
    "admin.charity.reviewTitle": "Xem xét {{name}}",
    "admin.charity.submittedRelative": "Đã gửi {{when}}",
    "admin.charity.contactEmail": "Email",
    "admin.charity.contactPhone": "Điện thoại",
    "admin.charity.raisedUnavailable": "Không có tổng số quyên góp",
    "admin.error.title": "Lỗi tải dữ liệu",
    "admin.error.recentActivity": "Lỗi tải hoạt động gần đây",
    "admin.error.alerts": "Lỗi tải cảnh báo",
    "admin.error.donationVolume": "Lỗi tải khối lượng quyên góp",
    "donation.gas.estimating": "Đang ước tính phí mạng…",
    "donation.gas.label": "Phí mạng ước tính",
    "donation.gas.highGasWarning":
      "Cảnh báo phí gas cao: phí ước tính là {{usd}}, chiếm {{pct}} khoản quyên góp của bạn.",
    "donation.gas.highGasSuggestion":
      "Hãy cân nhắc quyên góp số tiền lớn hơn hoặc chuyển sang chuỗi có phí thấp hơn.",
    "donation.gas.l2Hint": "Để có phí thấp hơn, hãy thử {{chains}}.",
  },
};
