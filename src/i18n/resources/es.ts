export default {
  translation: {
    ...
    "admin.dashboard.alertsView": "Ver",
    ...
    "admin.charity.searchByNameEin": "Buscar por nombre o ID fiscal…",
    ...
    "admin.charity.unnamed": "Organización sin nombre",
    ...
    "admin.charityRequests.subtitle":
      "Solicitudes de donantes para organizaciones no registradas, agrupadas por organización. Las organizaciones de mayor interés deben priorizarse para contacto.",
    ...
    "admin.charityRequests.showing":
      "Mostrando {{shown}} de {{total}} organizaciones únicas.",
    ...
    "auth.signin.sslEncrypted": "Cifrado TLS",
    "auth.signin.modeToggleLabel": "Método de acceso",
    ...
    "browse.hero.subtitle":
      "Descubre causas verificadas, dona con tarjeta o activos digitales y ve el impacto tangible de tu tiempo y recursos.",
    ...
    "browse.charity.nteeLabel": "Código de sector",
    ...
    "charity.profile.rowRulingYear": "Año de registro",
    "charity.profile.rowNteeCode": "Código de sector",
    ...
    "donation.art9Consent.statement":
      "Entiendo que mi registro de donación me vincula con {{charity}}. En la medida en que esto pueda indicar una afiliación religiosa, política o filosófica, consiento expresamente que Give Protocol procese este registro para completar y administrar mi donación.",
    "donation.art9Consent.label": "Consentimiento de datos de donación",
    "donation.art9Consent.required":
      "Debe dar su consentimiento al procesamiento de datos de donación para continuar.",
    ...
    "admin.auditTrail.filterByAction": "Filtrar por acción",
    ...
    "admin.auditTrail.action.viewPii": "Ver PII",
    "admin.auditTrail.action.viewPiiList": "Ver lista de PII",
    "admin.auditTrail.viewedEntity":
      "El administrador {{adminId}} vio {{entityType}} {{entityId}}",
    "admin.auditTrail.viewedList":
      "El administrador {{adminId}} vio la lista de {{entityType}} (página {{page}}, filtros: {{filters}})",
    "admin.auditTrail.viewedListNoFilters":
      "El administrador {{adminId}} vio la lista de {{entityType}} (página {{page}})",
    "admin.actions.platformNews": "Novedades de la Plataforma",
    "admin.actions.platformNewsDesc":
      "Gestionar las novedades mostradas en la página de exploración",
    "admin.news.activate": "Activar {{title}}",
    "admin.news.activated": "Novedad publicada",
    ...
    "admin.news.dateLabel": "Fecha de Publicación",
    "admin.news.deactivate": "Desactivar {{title}}",
    "admin.news.deactivated": "Novedad ocultada",
    "admin.news.deleteItem": "Eliminar {{title}}",
    "admin.news.deleted": "Novedad eliminada",
    "admin.news.editItem": "Editar {{title}}",
    "admin.news.editNews": "Editar Novedad",
    "admin.news.imageLabel": "URL de la imagen (opcional)",
    "admin.news.imagePlaceholder": "https://...",
    "admin.news.inactive": "Inactiva",
    "admin.news.newItem": "Nuevo Elemento",
    "admin.news.noItemsMessage":
      "Cree su primera novedad para compartir actualizaciones con su comunidad",
    "admin.news.noItemsYet": "Aún no hay novedades",
    "admin.news.publishedOn": "Publicada el {{date}}",
    "admin.news.saving": "Guardando...",
    "admin.news.subtitle":
      "Gestione las novedades mostradas en la página pública de exploración",
    "admin.news.title": "Novedades de la Plataforma",
    "admin.news.titleLabel": "Título",
    "admin.news.titlePlaceholder": "p. ej. Informe trimestral de impacto",
    "admin.news.updateNews": "Actualizar Novedad",
    ...
    "charity.walletBadge.safeLabel":
      "Tesorería multifirma · {{threshold}} de {{count}} firmantes",
    "charity.walletBadge.safeTooltip":
      "Las donaciones se envían a una billetera de firma múltiple que requiere varias aprobaciones antes de poder mover los fondos.",
    "wallet.eoa.chain": "Red",
    "wallet.eoa.checkAuthorized":
      "Estoy autorizado por mi organización para designar esta billetera como dirección receptora de donaciones benéficas.",
    "wallet.eoa.checkRisk":
      "Entiendo que una billetera de un solo firmante conlleva un riesgo mayor que una multifirma, y que la pérdida de la clave privada implica la pérdida permanente de los fondos.",
    "wallet.eoa.confirmSubtitle":
      "Confirme lo siguiente antes de registrar esta billetera.",
    "wallet.eoa.confirmTitle": "Confirmación final",
    "wallet.eoa.connectFirst": "Conecte primero su billetera.",
    "wallet.eoa.connectWallet": "Conectar billetera",
    "wallet.eoa.missingSignature":
      "Falta la firma. Vuelva atrás y firme de nuevo.",
    "wallet.eoa.proceedAnyway": "Entiendo, continuar",
    "wallet.eoa.register": "Registrar billetera",
    "wallet.eoa.registering": "Registrando...",
    "wallet.eoa.rejected": "La solicitud de firma fue rechazada.",
    "wallet.eoa.riskParagraph1":
      "Una billetera de un solo firmante (EOA) está controlada por una única clave privada. Si esa clave se pierde, es robada o queda comprometida, todos los fondos enviados a esta billetera son irrecuperables de forma permanente.",
    "wallet.eoa.riskParagraph2":
      "Para fondos organizacionales, recomendamos encarecidamente usar en su lugar una billetera multifirma Safe. Las billeteras multifirma requieren varias aprobaciones para cada transacción, protegiendo contra puntos únicos de falla.",
    ...
    "wallet.eoa.signTitle": "Conectar y firmar",
    "wallet.eoa.useMultisig": "Usar una multifirma en su lugar",
    "wallet.eoa.walletConnection": "Billetera",
    "wallet.eoa.walletToRegister": "Billetera a registrar",
    "wallet.institutional.address": "Dirección de la billetera",
    "wallet.institutional.attestation": "Documento de certificación",
    ...
    "wallet.safe.chain": "Red",
    "wallet.safe.connectFirst": "Conecte primero su billetera firmante.",
    "wallet.safe.connectSigner": "Conectar billetera firmante",
    "wallet.safe.createNew": "Crear una nueva Safe",
    "wallet.safe.createNewDesc":
      "Abre app.safe.global donde puede crear una nueva multifirma. Vuelva aquí una vez que esté desplegada.",
    "wallet.safe.haveOne": "Ya tengo una Safe",
    "wallet.safe.haveOneDesc":
      "Introduzca la dirección de su Safe y verifique el control firmando un mensaje desde una billetera firmante.",
    "wallet.safe.invalidAddress":
      "Introduzca una dirección de Ethereum válida (0x...)",
    "wallet.safe.rejected": "La solicitud de firma fue rechazada.",
    "wallet.safe.signError":
      "No se pudo firmar el mensaje de verificación. Inténtelo de nuevo.",
    "wallet.safe.signVerify": "Firmar para verificar",
    "wallet.safe.signerWallet": "Billetera firmante",
    "wallet.safe.subtitle":
      "Una Safe requiere que varios firmantes aprueben cada transacción, proporcionando el mayor nivel de seguridad para los fondos de su organización.",
    "wallet.safe.title": "Configurar una billetera multifirma Safe",
    "wallet.safe.verifyTitle": "Verificar propiedad de la Safe",
    "wallet.safe.verifying": "Verificando...",
    "wallet.setup.addAnother": "Añadir otra",
    "wallet.setup.custodian": "Custodio",
    "wallet.setup.deleteFailed": "Error al eliminar la billetera",
    "wallet.setup.eoaDesc":
      "Una billetera estándar controlada por una única clave privada. La más simple, pero la menos segura para uso organizacional.",
    "wallet.setup.eoaTitle": "Un Solo Firmante (EOA)",
    "wallet.setup.institutionalDesc":
      "Gestionada por un custodio calificado (Fireblocks, Anchorage, etc.). Requiere documento de certificación.",
    ...
    "wallet.setup.safeDesc":
      "Se requieren varios firmantes para cada transacción. La máxima seguridad para fondos organizacionales.",
    "wallet.setup.safeSigners": "Firmantes",
    "wallet.setup.safeTitle": "Safe Multifirma",
    "wallet.setup.subtitle":
      "Elija cómo recibirá su organización las donaciones en criptomonedas. Recomendamos una billetera multifirma para máxima seguridad.",
    "wallet.setup.title": "Configure su billetera receptora",
    "wallet.setup.viewExplorer": "Ver en el explorador de bloques",
    "wallet.setup.walletAdded": "Billetera registrada correctamente",
    "wallet.setup.walletDeleted": "Billetera eliminada",
    "wallet.setup.walletsTitle": "Billeteras receptoras",
    "admin.nav.dashboard": "Panel",
    "admin.nav.reports": "Informes y Análisis",
    "admin.nav.charities": "Organizaciones",
    "admin.nav.donations": "Donaciones",
    "admin.nav.impactMetrics": "Métricas de Impacto",
    "admin.nav.portfolioFunds": "Fondos de Portafolio",
    "admin.nav.contentModeration": "Moderación de Contenido",
    "admin.nav.settings": "Configuración del Sistema",
    "admin.nav.overview": "Resumen",
    "admin.nav.operations": "Operaciones",
    "admin.nav.consoleLabel": "Consola de Administración",
    "admin.shell.searchPlaceholder":
      "Buscar donantes, organizaciones, hash de tx…",
    "admin.shell.searchLabel": "Buscar en la consola de administración",
    "admin.shell.notifications": "Notificaciones",
    "admin.shell.adminLabel": "admin",
    "admin.shell.superAdmin": "Super Administrador",
    "admin.shell.signOut": "Cerrar sesión",
    "admin.shell.backToPublicSite": "Volver al sitio público",
    "admin.shell.homeLink": "Inicio de Give Protocol",
    "admin.dashboard.severityHigh": "Alta Prioridad",
    "admin.dashboard.severityMedium": "Requiere Atención",
    "admin.dashboard.severityLow": "Para Revisión",
    "admin.dashboard.alertOldest": "Solicitud más antigua enviada",
    "admin.dashboard.alertReviewHint":
      "revisión para mantener el proceso de incorporación en marcha",
    "admin.dashboard.reviewQueue": "Cola de revisión",
    "admin.dashboard.kpiDonorsSub": "{{count}} nuevos en los últimos 30 días",
    "admin.dashboard.kpiPending": "{{count}} pendientes",
    "admin.dashboard.awaitingVerification": "Pendiente de verificación",
    "admin.dashboard.kpiVerifiedSub": "de {{total}} aprobadas en total",
    ...
    "admin.dashboard.volumeEmptyTitle": "Aún no hay donaciones registradas",
    "admin.dashboard.volumeEmptySub":
      "El volumen se graficará aquí una vez que se liquide el primer donativo",
    "admin.dashboard.totalVolume": "Volumen total",
    "admin.dashboard.crypto": "Cripto",
    "admin.dashboard.fiat": "Fiat",
    "admin.dashboard.activitySubtitle":
      "Eventos de la plataforma a medida que ocurren",
    "admin.dashboard.viewAllActivity": "Ver toda la actividad",
    "admin.dashboard.viewAllDonations": "Ver todas las donaciones",
    "admin.charity.tabAll": "Todas",
    "admin.charity.review": "Revisar",
    "admin.charity.colOrganization": "Organización",
    "admin.charity.colRaised": "Recaudado",
    "admin.charity.colSubmitted": "Enviado",
    "admin.charity.searchAria": "Buscar organizaciones",
    "admin.charity.reviewTitle": "Revisar {{name}}",
    ...
    "donation.gas.highGasWarning":
      "Alerta de tarifa alta: la tarifa estimada es {{usd}}, que representa {{pct}} de su donación.",
    "donation.gas.highGasSuggestion":
      "Considere una donación mayor o cambiar a una cadena con tarifas más bajas.",
    "donation.gas.l2Hint": "Para tarifas más bajas, pruebe {{chains}}.",
  },
};
