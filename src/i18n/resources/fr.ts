export default {
  translation: {
    ...
    "charity.profile.donate.walletUnset": "Cette organisation n'a pas encore configuré de portefeuille officiel.",
    "charity.profile.donate.walletPending": "Cette organisation finalise la configuration de son portefeuille — les dons sont temporairement indisponibles.",
    "charity.profile.donate.walletLegacy": "Cette organisation utilise une adresse de portefeuille héritée.",
    "charity.profile.donate.feeNote": "0% de frais de plateforme sur les dons directs. Des frais de réseau s'appliquent.",
