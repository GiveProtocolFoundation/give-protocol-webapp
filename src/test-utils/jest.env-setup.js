...
globalThis.import = {
  meta: {
    env: {
      ...
      VITE_MONITORING_ENABLED_MONITORS: 'webVital,error,resource,navigation,paint,api,custom,userAction',
      VITE_BASE_RPC_URL: '',
      ...
      VITE_VERIFICATION_CONTRACT_ADDRESS: '0x2345678901234567890123456789012345678901',
      VITE_DISTRIBUTION_CONTRACT_ADDRESS: '0x3456789012345678901234567890123456789012',
      VITE_PORTFOLIO_FUNDS_CONTRACT_ADDRESS: '0x5678901234567890123456789012345678901234',
      MODE: 'test',
      DEV: false,
      PROD: false,
    },
