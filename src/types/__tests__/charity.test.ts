...
describe("CharityCategory", () => {
  it("has all expected category values", () => {
    ...
    expect(CharityCategory.INTERNATIONAL_DEVELOPMENT).toBe(
    ...
    expect(CharityCategory.GRANTMAKING_FOUNDATIONS).toBe(
...
describe("CHARITY_CATEGORY_LABELS", () => {
  ...
  it("maps education to correct label", () => {
    expect(CHARITY_CATEGORY_LABELS[CharityCategory.EDUCATION]).toBe(
      "Education",
    );
  });
