...
describe("formatFiat", () => {
  ...
  it("should respect custom decimal places", () => {
    expect(formatFiat(1234.567, usdCurrency, { decimals: 0 })).toContain(
      "1,235",
    );
    expect(formatFiat(1234.567, usdCurrency, { decimals: 3 })).toContain(
      "1,234.567",
    );
  });
...
describe("formatCrypto", () => {
  ...
  it("should respect custom decimal option", () => {
    expect(formatCrypto(1.23456789, ethToken, { decimals: 2 })).toContain(
      "1.23",
    );
  });
